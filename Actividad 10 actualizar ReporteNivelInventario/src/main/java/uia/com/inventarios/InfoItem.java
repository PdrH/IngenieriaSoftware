...
//esta clase nos da la informacion de lote y ubicacion del material en el almacen, ademas de agrega la informacion particular de cada item
/*
tiene una agregacion con lote y ubicacion
 */
public class InfoItem extends InfoUIA{
    ...
    public List<InfoItem> getItems(String cantidad)
    {
        ...
        //todo crea un mapa dentro de la lista para iterar
        for (Map.Entry<String, InfoItem> item : this.getItems().entrySet())//esta navegando en el mapa
        {
            InfoItem nodo =  item.getValue();
            ...
            // es por eso que cada que le pido get items imprime
            //nodo.print();
        }
        return itemsTemp;
    }
